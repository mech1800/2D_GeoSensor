...
def mk_image(output, label, mode, max):
    ...
    for i in range(15):
        ...
        if mode == 'tr':
            im1 = ax1.imshow(tr_data[i*4][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)
            im2 = ax2.imshow(tr_data[i*4+1][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)
            im3 = ax3.imshow(tr_data[i*4+2][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)
            im4 = ax4.imshow(tr_data[i*4+3][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)

        if mode == 'va':
            im1 = ax1.imshow(va_data[i*4][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)
            im2 = ax2.imshow(va_data[i*4+1][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)
            im3 = ax3.imshow(va_data[i*4+2][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)
            im4 = ax4.imshow(va_data[i*4+3][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)

        im1 = ax1.imshow(output[i*4][0], cmap=cm.jet, alpha=1, vmin=0, vmax=max)
        im2 = ax2.imshow(output[i*4+1][0], cmap=cm.jet, alpha=1, vmin=0, vmax=max)
        im3 = ax3.imshow(output[i*4+2][0], cmap=cm.jet, alpha=1, vmin=0, vmax=max)
        im4 = ax4.imshow(output[i*4+3][0], cmap=cm.jet, alpha=1, vmin=0, vmax=max)
        ...
        ax4.set_ylabel('4', va='center', rotation='horizontal', labelpad=10, fontsize=12)
        ...
        if mode == 'tr':
            im5 = ax5.imshow(tr_data[i*4][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)
            im6 = ax6.imshow(tr_data[i*4+1][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)
            im7 = ax7.imshow(tr_data[i*4+2][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)
            im8 = ax8.imshow(tr_data[i*4+3][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)

        if mode == 'va':
            im5 = ax5.imshow(va_data[i*4][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)
            im6 = ax6.imshow(va_data[i*4+1][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)
            im7 = ax7.imshow(va_data[i*4+2][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)
            im8 = ax8.imshow(va_data[i*4+3][1], cmap='gray_r', alpha=0.2, vmin=0, vmax=1)

        im5 = ax5.imshow(label[i*4][0], cmap=cm.jet, alpha=1, vmin=0, vmax=max)
        im6 = ax6.imshow(label[i*4+1][0], cmap=cm.jet, alpha=1, vmin=0, vmax=max)
        im7 = ax7.imshow(label[i*4+2][0], cmap=cm.jet, alpha=1, vmin=0, vmax=max)
        im8 = ax8.imshow(label[i*4+3][0], cmap=cm.jet, alpha=1, vmin=0, vmax=max)
